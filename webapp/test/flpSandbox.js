		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "lista",
									"targetURL": "#cursoproductosproductos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cursoproductosproductos-display": {
								"semanticObject": "cursoproductosproductos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=curso.productos.productos",
									"url": sap.ui.require.toUrl("curso/productos/productos")
								}
							}
						}
					}
